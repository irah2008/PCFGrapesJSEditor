...
export class GrapeJSTemplate implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	private _context: ComponentFramework.Context<IInputs>;
	private _container: HTMLDivElement;
	private _html: string | any;
	private _css: string | any;
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container: HTMLDivElement) {
		...
		editor.on('change:changesCount', (model: any) => { this.onValueChange(editor) });
		this._editor = editor;
	}
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void {
		...
		this._editor.setComponents(context.parameters.multiLineHTML.raw);
	}
	...
	public getOutputs(): IOutputs {
		return { multiLineHTML: this._html };
	}
